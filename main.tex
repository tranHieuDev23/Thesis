...
\vspace{0.3cm}
\begin{center}
    \large\textbf{NHIỆM VỤ ĐỒ ÁN TỐT NGHIỆP}
\end{center}
...
\begin{enumerate}
    \item Huấn luyện mô hình học sâu (Deep Learning) StarGAN v2 để biến đổi ảnh nội soi thuộc chế độ màu sắc cơ bản sang các chế độ màu sắc cao cấp.
