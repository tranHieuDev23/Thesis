...
Chương trình huấn luyện mô hình StarGAN v2 được cài đặt bằng ngôn ngữ Python 3.6.9, sử dụng thư viện Pytorch. Chương trình sử dụng thuật toán tối ưu Adam theo lô, mỗi lô có 4 ảnh, chạy qua 50 nghìn bước lặp trên một GPU Nvidia GeForce RTX 3090 trong khoảng thời gian 2 ngày. Các hệ số được sử dụng cho quá trình luyện tập bao gồm:
\begin{itemize}
...
Mã nguồn của chương trình luyện tập mô hình được lưu trữ tại địa chỉ \\\href{https://github.com/tranHieuDev23/StarGAN-v2}{github.com/tranHieuDev23/StarGAN-v2}.
