...
Tuy nhiên, phương án này khiến ta không thể chỉnh sửa được độ sáng hay độ tương phản của ảnh, do các đặc điểm này bị ảnh hưởng chủ yếu bởi kênh Y. Điều này khiến cho kết quả đầu ra thiếu đi độ tương phản của ảnh thật.

\subsection{PatchGAN}

PatchGAN được để xuất trong
